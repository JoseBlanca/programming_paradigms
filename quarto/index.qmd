...
It is a common mistake, specially among beginers, to think that our aim when we write computer code is to create fast and memory efficient, very performant, programs.
